...
public class MainManuActivity extends AppCompatActivity {
    ...
    TextView tvCases, tvRecovered, tvCritical, tvActive, tvTodayCases, tvTotalDeaths, tvTodayDeaths, tvAffectedCountries, tvTests;
    ...
    private void fetchData() {
        ...
        StringRequest request = new StringRequest(Request.Method.GET, url,
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                simpleArcLoader.setVisibility(View.GONE);
                scrollView.setVisibility(View.VISIBLE);
                Toast.makeText(MainManuActivity.this, error.getMessage(), Toast.LENGTH_SHORT).show();
            }
        });
